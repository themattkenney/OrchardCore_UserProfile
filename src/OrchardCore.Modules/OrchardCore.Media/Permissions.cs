...
namespace OrchardCore.Media
{
    public class Permissions : IPermissionProvider
    {
        ...
        public static readonly Permission ManageMediaFieldsFolder = new Permission("ManageMediaFieldsFolder", "Manage Media Fields Folder");

        public IEnumerable<Permission> GetPermissions()
        {
            return new[] { ManageMedia, ManageOwnMedia, ManageMediaFieldsFolder };
        }
        ...
        public IEnumerable<PermissionStereotype> GetDefaultStereotypes()
        {
            return new[] {
                new PermissionStereotype {
                    Name = "Administrator",
                    Permissions = new[] { ManageMedia, ManageMediaFieldsFolder }
                },
                new PermissionStereotype {
                    Name = "Editor",
